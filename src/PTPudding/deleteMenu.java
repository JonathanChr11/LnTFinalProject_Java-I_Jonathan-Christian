...
public class deleteMenu extends JFrame implements ActionListener, MouseListener, MenuListener {
	...
	JButton deleteBtn, clearBtn, backBtn;
	JTable userTable;
	JScrollPane tableScrollPane;

	public deleteMenu(Vector<Data> data) {
